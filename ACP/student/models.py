...
class Question(models.Model):
    ...
    optionA = models.CharField('A选项', max_length=1024)
    optionB = models.CharField('B选项', max_length=1024)
    optionC = models.CharField('C选项', max_length=1024)
    optionD = models.CharField('D选项', max_length=1024)
...
class Paper(models.Model):
    ...
    subject = models.CharField('科目', max_length=1024, default='')
    major = models.CharField('考卷适用专业', max_length=50)
